알겠습니다. 제공해주신 위시켓 프로젝트 정보를 바탕으로 이모지를 활용하여 README를 작성하겠습니다.

## CareBear - AI 말벗 로봇 🐻👵👴

[https://hwkims.github.io/carebear/](https://hwkims.github.io/carebear/)

CareBear는 독거 노인 👴👵 분들을 위한 치매 예방 🧠 및 정서적 안정 💖을 돕는 음성 기반 AI 대화 로봇 🤖입니다. ChatGPT API를 활용하여 맞춤형 대화를 제공하고, 사용자의 감정을 케어하는 데 중점을 둡니다. 위시켓 프로젝트 [ChatGPT 기반 치매 예방 및 감정 케어 목적의 음성 기반 AI 대화 로봇 개발](https://www.wishket.com/project/12345/) (가상의 링크)의 MVP(최소 기능 제품) 개발을 위해 만들어졌습니다.

### ✨ 주요 기능 ✨

*   **👵👴 맞춤형 대화:** ChatGPT API를 활용하여 독거 노인에게 적합한 맞춤형 대화를 생성합니다. 1,000개 이상의 대화 예제를 활용하여 파인 튜닝 및 프롬프팅을 진행합니다.
*   **💖 감정 케어:** 사용자의 감정 (기쁨 😄, 슬픔 😭, 분노 😡 등)을 인식하여 적절한 위로와 공감을 제공합니다.
*   **🎤 음성 인터페이스:** 노인 분들이 쉽게 사용할 수 있도록 음성 기반 UI/UX를 설계했습니다. STT(Speech-to-Text) 및 TTS(Text-to-Speech) 변환 기능을 제공합니다.
*   **📊 데이터 분석:** 사용자 대화 데이터를 수집하고 분석하여 서비스 개선에 활용합니다. (관리자 페이지에서 확인 가능)
*   **☁️ 클라우드 기반:** 1년 동안 안정적인 서비스 운영을 위해 클라우드 서버를 구축했습니다. (약 100명 사용자 기준)
...
3.  **API 키 구성:**
    ...
    *   다음 줄을 찾습니다.
        ...
        ```javascript
        const apiKey = 'YOUR_OPENAI_API_KEY'; // TODO: 실제 API 키로 바꾸세요
        ```

    *   `YOUR_OPENAI_API_KEY`를 실제 OpenAI API 키로 바꿉니다.
...
2.  **GitHub Pages 활성화:**
    ...
    *   "Pages" 섹션에서 "Source"를 "main" (또는 사용하는 분기)으로 설정하고 저장합니다.
